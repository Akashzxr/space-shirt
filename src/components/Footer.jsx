...
export default function Footer() {
  return (
    <div className='bg-gray-800 h-64 w-full mt-40 flex items-center justify-around'>
      ...
      <div className='flex text-white font-Cannon font-extralight gap-20'>
        <div>HOME</div>
        <div>PRODUCT</div>
        <div>CONTACT</div>
        <div>HELP</div>
      ...
      <div className='flex gap-11 items-center'> 
        <h3 className='font-Cannon text-white'>FOLLOW US</h3>
